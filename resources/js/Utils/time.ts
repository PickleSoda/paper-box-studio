...
// Returns a 2D Array of a Day and Dates
...
export const getWeekHours = (startDate = dayjs()) => {
    ...
    for (let i = 0; i < 24; i++) {
        ...
        for (let j = 0; j < 4; j++) {
            ...
            const formattedInterval =
                currentInterval.format("DD-MM-YYYY HH:mm ");
            hourArray.push(formattedInterval);
        }
